...
<section class="main-content">
    <div class="mentor-details">
        <section id="allocate">
            ...
            <div class="container mx-auto mt-10">
                <h1 class="text-2xl font-bold mb-5">Allocate Mentor to Team</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Team</th>
                    ...
                    <tbody>
                        <?php
                            // Fetch teams and mentors from the database
                            ...
                            while ($team = mysqli_fetch_assoc($teams_result)) {
                                ...
                                echo "<td>";
                                echo "<form method='POST' action='mentor_dash.php' class='inline'>";
                                ...
                                echo "<button type='submit' class='bg-blue-500 text-white p-2 rounded-lg'>Allocate</button>";
                                echo "</form>";
                                echo "</td>";
                                echo "</tr>";
                            }
    ...
    <section id="statistics">
        <!-- Statistics can be displayed here -->
    </section>
</section>
